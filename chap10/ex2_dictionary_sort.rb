...
#Dictionary sorting - ignoring capitals

def dictionary_sort_words words
    recursive_dictionary_sort_words words, []
end

def recursive_dictionary_sort_words unsorted_words, sorted_words
    ...
    recursive_dictionary_sort_words still_unsorted, sorted_words
end
...
puts (dictionary_sort_words(words_to_sort))
